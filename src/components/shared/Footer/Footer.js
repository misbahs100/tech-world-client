...
const explore = [
    { name: "Computer Products", link: "/computerProducts" },
...
const exploreMore = [
    ...
    { name: "Explore More", link: "/exploreMore" }
]
const contactUs = [
    ...
    return (
        <section style={{ backgroundColor: '#161616' }} className="footer-container">
                ...
                <div className="container">
                    <div className="row py-5">
                        ...
                        <FooterCol key={3} menuTitle="CONTACT US" menuItems={contactUs}>
                            <h6 className="text-white">Address: <span className="text-secondary">Dept of CSE, University of Chittagong, Chattogram</span></h6>
                            <br />
                            <div className="contact-list">
                                <li><FontAwesomeIcon style={{ color: '#ffc61a' }} icon={faPhoneAlt} /> 800-5-800</li>
                                <li><FontAwesomeIcon style={{ color: '#ffc61a' }} icon={faEnvelope} /> techworld.service@info.bd</li>
                                <li><FontAwesomeIcon style={{ color: '#ffc61a' }} icon={faSurprise} /> gettechservice</li>
                            </div>
                            <br />
            ...
            <div className="copyRight text-center">
                <p style={{ color: '#868686' }}><span>TECH WORLD</span> {(new Date()).getFullYear()} - All Rights Reserved <span>Terms of use</span></p>
            </div>
